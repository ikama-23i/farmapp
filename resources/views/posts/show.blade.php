...
@section('content')
    <article>
      <section>
        ...
        <p>A.現時点では果物狩りのみとなります。また、きまぐれに野菜を育てておりますので、タイミングが良ければ野菜もご一緒に収穫をすることがができます。そちらについては作物の成長具合にもよりますので、果物狩りと同時に収穫できる野菜等ありましたら <a href="{{ route('posts.news') }}">お知らせ</a>にて掲載いたします。 </p>
        <hr>
        ...
        <p>A.料金については <a href="{{ route('posts.harvest') }}">果物狩り【予約】</a>ページでご確認くださいませ。<br>お支払方法は誠に申し訳ございませんが『現金』のみになります。お手数おかけしますがよろしくお願いいたします。</p>
        <hr>
        ...
        <br>
        <br>
        <p>そのほか疑問点や質問などございましたら、お手数ですが <a href="{{ route('posts.contact') }}">お問い合わせ</a>ページにてお問い合わせください。</p>
      </section>
    </article>
  @endsection
  @section('footer')
